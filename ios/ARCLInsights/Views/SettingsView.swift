            ...
            Form {
                Section(header: Text("My Team")) {
                    TextField("Team Name", text: $myTeamName)
                        .onChange(of: myTeamName) { newValue in
                            dataManager.updateMyTeam(newValue)
                        }
                }
                ...
                Section(header: Text("Division & Season")) {
                    ...
                    .onChange(of: selectedDivisionID) { newValue in
                        dataManager.updateDivision(newValue)
                    }
                    ...
                    .onChange(of: selectedSeasonID) { newValue in
                        dataManager.updateSeason(newValue)
                    }
                }
